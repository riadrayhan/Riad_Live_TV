...
class DiscoveryCode extends StatefulWidget {
  const DiscoveryCode({super.key});

  @override
  State<DiscoveryCode> createState() => _DiscoveryCodeState();
}

class _DiscoveryCodeState extends State<DiscoveryCode> {
  @override
  Widget build(BuildContext context) {
    return Stack(
      children: [
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: const BlurContainerWidget(
              child: Center(child: Text("Discovery\nHindi",textAlign: TextAlign.center,style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,),)),
            ),
          ),
        ),
      ],
